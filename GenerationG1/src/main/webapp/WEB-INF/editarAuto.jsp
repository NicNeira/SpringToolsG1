...
<head>
<meta charset="UTF-8">
<title>Pagina para editar autp</title>
<link
...
<body>
	<div class="p-3 mb-2 bg-primary text-white">
		...
		<h1>Estas en la pagina para editar el auto asignado</h1>
		
		<form:form action="/autoTuneado/actualizar/${auto.id}" method="post"
			modelAttribute="auto" autocomplete="off">
			<!-- Nueva rueta actualizar/${auto.id} -->
